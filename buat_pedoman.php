...
// Cek NIK duplikat
$check = $pdo->prepare("SELECT COUNT(*) FROM layanan_pedoman WHERE judul = :judul");
...
$sql = "INSERT INTO layanan_pedoman (tanggal, judul, deskripsi,  file_url) 
...
try {
  ...
  echo "<script>alert('Tambah pedoman berhasil!'); window.location.href = 'layanan_pedoman.php';</script>";
  exit();
} catch (Exception $e) {
...
<body>
  ...
  <nav class="navbar-bottom">
    ...
    <section class="container">
      <h3>Tambah Pedoman</h3>
        <form action="buat pedoman.php" method="POST" enctype="multipart/form-data">
        <div class="input-row">
        <div class="input-row">
        ...
        <div class="input-row">
          <label for="file">File Pedoman</label>
