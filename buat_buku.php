...
// Cek NIK duplikat
$check = $pdo->prepare("SELECT COUNT(*) FROM koleksi WHERE judul = :judul");
...
$sql = "INSERT INTO koleksi (judul, penulis, tahun, deskripsi, image_url, file_url) 
...
try {
  ...
  echo "<script>alert('Tambah buku berhasil!'); window.location.href = 'koleksi.php';</script>";
  exit();
} catch (Exception $e) {
...
<body>
  ...
  <nav class="navbar-bottom">
    ...
    <section class="container">
      <h3>Tambah Buku</h3>
        <form action="buat_buku.php" method="POST" enctype="multipart/form-data">
        <div class="input-row">
