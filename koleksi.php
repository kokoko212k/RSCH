...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM koleksi WHERE judul LIKE '%$search%' OR penulis LIKE '%$search%' OR tahun LIKE '%$search%'";
} else {
...
<body>
  ...
  <div class="koleksi-search">    
      <?php if ($can_edit): ?>
          <a href="buat_buku.php" class="btn-tambah">+ Buku</a>
      <?php endif; ?>
                  ...
                  <div class="koleksi-card">
                      ...
                      <div class="koleksi-info">
                          ...
                          <?php if (!empty($row['id_buku'])): ?>
                              <a href="detail_buku.php?id=<?= urlencode($row['id_buku']) ?>" class="detail-btn" target="_blank">Lihat Detail</a>
                          <?php endif; ?>
                      </div>
                  </div>
              <?php endwhile; ?>
