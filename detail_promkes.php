...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus_id'])) {
    ...
    $hapus_query = "DELETE FROM layanan_promkes WHERE id = '$hapus_id'";

    if (mysqli_query($koneksi, $hapus_query)) {
        header("Location: layanan_promkes.php?hapus=berhasil");
        exit();
    } else {
...
$query = "SELECT * FROM layanan_promkes WHERE id = '$id'";
      ...
      <div class="buku-details">
        ...
        <?php if ($can_edit): ?>
          <div class="action-buttons">
            <a href="update_promkes.php?id=<?= urlencode($data['id']) ?>" class="btn-edit">Edit</a>
