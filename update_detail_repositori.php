...
// Ambil data buku
$stmt = $pdo->prepare("SELECT * FROM repositori WHERE id_buku = :id_buku");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $pdo->prepare("UPDATE repositori SET judul = :judul, penulis = :penulis, tahun = :tahun, deskripsi = :deskripsi, image_url = :image_url, file_url = :file_url WHERE id_buku = :id_buku");
    ...
    try {
        ...
        echo "<script>alert('Buku berhasil diupdate!'); window.location.href = 'repositori.php';</script>";
        exit();
    } catch (Exception $e) {
...
<section class="container">
    <h3>Edit Repositori</h3>
    <form action="update_detail_repositori.php?id_buku=<?= $buku['id_buku'] ?>" method="POST" enctype="multipart/form-data">
        <div class="input-row">
