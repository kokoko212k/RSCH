...
$pref_status = null;
try {
    $qPref = $pdo->prepare("SELECT ditujukan_kepada FROM surat_keluar WHERE no_surat = ? ORDER BY id DESC LIMIT 1");
...
<body>
  ...
  <div class="kontainer-balok">
    <div class="wrap">
      ...
      <div class="card">
        ...
        <form id="formSend" class="send" method="post" action="pesan_buat_4.php">
  ...
  function loadChat() {
    ...
    fetch('pesan_lihat_4.php?ajax=1&no_surat=' + encodeURIComponent(noSurat), {
