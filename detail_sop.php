...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus_id'])) {
    ...
    $hapus_query = "DELETE FROM layanan_sop WHERE id = '$hapus_id'";

    if (mysqli_query($koneksi, $hapus_query)) {
        header("Location: layanan_sop.php?hapus=berhasil");
        exit();
    } else {
...
$query = "SELECT * FROM layanan_sop WHERE id = '$id'";
      ...
      <div class="buku-details">
        ...
        <?php if ($can_edit): ?>
          <div class="action-buttons">
            <a href="update_sop.php?id=<?= urlencode($data['id']) ?>" class="btn-edit">Edit</a>
