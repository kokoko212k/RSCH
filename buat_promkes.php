...
// Cek NIK duplikat
$check = $pdo->prepare("SELECT COUNT(*) FROM layanan_promkes WHERE judul = :judul");
...
$sql = "INSERT INTO layanan_promkes (tanggal, judul, deskripsi,  file_url) 
...
try {
  ...
  echo "<script>alert('Tambah promkes berhasil!'); window.location.href = 'layanan_promkes.php';</script>";
  exit();
} catch (Exception $e) {
...
<body>
  ...
  <nav class="navbar-bottom">
    ...
    <section class="container">
      <h3>Tambah Promkes</h3>
        <form action="buat promkes.php" method="POST" enctype="multipart/form-data">
        <div class="input-row">
        <div class="input-row">
        ...
        <div class="input-row">
          <label for="file">File Promkes</label>
