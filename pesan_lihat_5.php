...
$pref_status = null;
try {
    $qPref = $pdo->prepare("SELECT no_surat FROM surat_notif WHERE no_surat = ? ORDER BY id DESC LIMIT 1");
  ...
  <div class="kontainer-balok">
    <div class="wrap">
      ...
      <div class="card">
        ...
        <form id="formSend" class="send" method="post" action="pesan_buat_5.php">
