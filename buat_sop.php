...
// Cek NIK duplikat
$check = $pdo->prepare("SELECT COUNT(*) FROM layanan_sop WHERE judul = :judul");
...
$sql = "INSERT INTO layanan_sop (tanggal, judul, deskripsi,  file_url) 
...
try {
  ...
  echo "<script>alert('Tambah sop berhasil!'); window.location.href = 'layanan_sop.php';</script>";
  exit();
} catch (Exception $e) {
...
<body>
  ...
  <nav class="navbar-bottom">
    ...
    <section class="container">
      <h3>Tambah SOP</h3>
        <form action="buat sop.php" method="POST" enctype="multipart/form-data">
        <div class="input-row">
        <div class="input-row">
